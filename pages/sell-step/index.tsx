            ...
            <div className={styles.cardWrapper} data-aos="fade-in" data-aos-once="true">
              ...
              >
                ...
                <div className={styles.descriptionText}>
                  Qua các khâu kiểm duyệt, những món đồ đạt chất lượng sẽ được chụp ảnh, đăng bán và
                  vận chuyển bởi Passdy thay bạn
                </div>
              </div>
              <div
                data-aos="zoom-out"
              ...
              >
                ...
                <div className={styles.descriptionText}>
                  Người dọn đồ tiết kiệm thời gian, người mua đồ tiết kiệm chi phí. Đẹp - tiết kiệm
                  - bảo vệ môi trường
                </div>
              </div>
            </div>
